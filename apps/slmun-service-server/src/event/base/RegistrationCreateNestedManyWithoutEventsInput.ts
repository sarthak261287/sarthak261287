...
@InputType()
class RegistrationCreateNestedManyWithoutEventsInput {
...
export { RegistrationCreateNestedManyWithoutEventsInput as RegistrationCreateNestedManyWithoutEventsInput };
